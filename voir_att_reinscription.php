...
<head>
<meta charset="UTF-8">
<title>Attestation de Réinscription - <?= $prenom ?> <?= $nom ?></title>
<style>
body { font-family: 'Georgia', serif; margin:0; padding:0; background:#f5f5f5; }
.attestation { width: 210mm; height: 297mm; margin: 20px auto; padding: 40px; position: relative; background:#fff; border:2px solid #000; box-shadow:0 0 20px rgba(0,0,0,0.3); overflow:hidden; }
.attestation::before { content: "UNIVERSITE DE LABE"; position:absolute; top:50%; left:50%; transform:translate(-50%,-50%) rotate(-30deg); font-size:100px; font-weight:bold; color:rgba(0,0,0,0.07); white-space:nowrap; z-index:0; pointer-events:none; }
...
@media print { body { background:none; } .attestation { box-shadow:none; border:none; margin:0; page-break-after:always; } }
</style>
</head>
<body>
<div class="attestation">
    ...
    <div class="overlay">
        ...
        <div class="contenu">
            <p>Je soussigné, <strong>Issa SOUMARE</strong>, certifie que <strong><?= $prenom ?> <?= $nom ?></strong> (INE : <?= $ine ?>)</p>
            <p>est régulièrement <strong>réinscrit(e)</strong> en <strong><?= $niveau ?></strong> pour l'année universitaire <strong><?= $annee_univ ?></strong>.</p>
