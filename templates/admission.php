...
<div class="attestation">
  ...
  atteste que <b><?= htmlspecialchars(strtoupper($etudiant['Prenom']." ".$etudiant['Nom'])) ?></b>, né(e) le <?= date("d/m/Y", strtotime($etudiant['DateNaissance'])) ?> à <?= htmlspecialchars($etudiant['LieuNaissance']) ?>,
